...
# мої особисті додатки
# Встановлюємо бібліотеки .NET
	choco install dotnet4.7.1 -y
 	choco install dotnet -y
# Встановлюємо бібліотеки Java
	choco install openjdk -y
 
# Встановлюємо Discord
	choco install discord -y
 # Встановлюємо Skype
	choco install skype -y
# Встановлюємо Google Drive
	choco install googledrive -y
# Встановлюємо Paint.NET
	choco install paint.net -y
# Встановлюємо TeraCopy
	choco install teracopy -y
# Встановлюємо Glary (перевіряє наявність оновлень для встановлених застосунків)
	choco install glaryutilities-free -y
# Встановлюємо qBitTorrent
	choco install qbittorrent -y
# Встановлюємо Telegram
